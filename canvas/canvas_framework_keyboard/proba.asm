...
make_image proc
	...
	imul ecx, 4; in ecx facem image_height*image_width*4(4 deoarece pixeli nostri sunt de tip dd) pentru a avea aria completra a unei poze
	mov ebx, [ebp+arg4]; in ebx imi pun arg4 care mi a cata carte vreau sa afisez
	dec ebx
	imul ecx, ebx; inmultesc cu a tata carte vreau sa afisez ca sa ii dau puntul de start
